...
User.create_new_tool('2', 'Screwdriver 3', 'A green screwdriver', 'screwdriver', "Andrew", "email me!")
User.create_new_tool('3', 'Screwdriver 4', 'A purple screwdriver', 'screwdriver', "Schmitty", "email me!")
User.create_new_tool('2', 'Drill 1', 'A blue drill', 'drill', "Andrew", "email me!")
User.create_new_tool('1', 'Drill 2', 'An orange drill', 'drill', "Dan", "knock on my door")
