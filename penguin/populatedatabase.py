...
Tool.create_new_tool('Screwdriver 3', User.get_user(1), 'A green screwdriver', 'screwdriver', False, "email me!")
Tool.create_new_tool('Screwdriver 4', User.get_user(2), 'A purple screwdriver', 'screwdriver', False, "email me!")
Tool.create_new_tool('Drill 1', User.get_user(3), 'A blue drill', 'drill', False, "email me!")
Tool.create_new_tool('Drill 2', User.get_user(4), 'An orange drill', 'drill', False, "knock on my door")
Tool.create_new_tool('Drill 3', User.get_user(1), 'A purple drill', 'drill', True, "find me at work")
b = User.get_user(2)
t = Tool.get_tool(1)
